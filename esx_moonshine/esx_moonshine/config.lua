...
Config.Drugs = {
	...
	[_U('moonshine')] = {
		...
		Zones			= {
			...
			Dealer 		= {x = 381.37,	y = 3561.69,	z = 33.33-1.0001, h = 271.88,	name = _U('dealer', _U('moonshine')),		sprite = 500,	color = 75, callPolice = false, callPoliceChance = 100, NPCHash = -429715051, sellMin = 200, sellMax = 500, multiplierPolice = true},
		}
	}
